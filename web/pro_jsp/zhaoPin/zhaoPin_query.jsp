...
<html xmlns="http://www.w3.org/1999/xhtml">
		<head>
			...
			<script type="text/javascript">
				function toPage(pageNum){
					var url = "zhaoPin/zhaoPin_query.do?curPage="+pageNum;
		...
		<body>
			...
			<div class="content-box-header">
				<h3><public:i18n key="function.manager" module="zhaoPin"></public:i18n></h3>
							...
							<table>
								...
								<c:forEach items="${result}" var="record">
									<tr>
										...
										<td>
											<a style="cursor: pointer;" onclick="gotoEdit('<%=basePath %>zhaoPin/zhaoPin_edit.do?id=${record.id }')" title="Edit"><img src="resources/images/icons/pencil.png" alt="Edit" /></a>
											<a style="cursor: pointer;" onclick="actionDel('<%=basePath %>zhaoPin/zhaoPin_del.do?id=${record.id }')" title="Delete"><img src="resources/images/icons/cross.png" alt="Delete" /></a>
										</td>
									</tr>
								</c:forEach>
								</tbody>
