		...
		<head>
			...
			<script type="text/javascript">
				function toPage(pageNum){
					var url = "partTimeInfo/partTimeInfo_query4me.do?curPage="+pageNum;
		...
		<body>
			...
			<div class="content-box-content">
				...
				<jsp:include page="/sys_jsp/notification.jsp"></jsp:include>
					<form id="searchForm" name="searchForm" action="partTimeInfo/partTimeInfo_query4me.do" method="post">
								...
								<c:forEach items="${result}" var="record">
									<tr>
										...
										<!--<td><a href="<%=basePath %>partTimeInfo/partTimeInfo_detail.do?id=${record.id }" title="title">${record.id }</a></td>-->
											<td>${record.types}</td>
											<td><a href="<%=basePath %>partTimeInfo/partTimeInfo_detail4me.do?id=${record.id }" title="title">${record.title}</a></td>
											<!-- 
										...
										<td>
											<a style="cursor: pointer;" onclick="gotoEdit('<%=basePath %>partTimeInfo/partTimeInfo_edit4me.do?id=${record.id }')" title="Edit"><img src="resources/images/icons/pencil.png" alt="Edit" /></a>
											<a style="cursor: pointer;" onclick="actionDel('<%=basePath %>partTimeInfo/partTimeInfo_del4me.do?id=${record.id }')" title="Delete"><img src="resources/images/icons/cross.png" alt="Delete" /></a>
										</td>
									</tr>
								</c:forEach>
								</tbody>
