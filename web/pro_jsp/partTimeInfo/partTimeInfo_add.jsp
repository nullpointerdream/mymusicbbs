		...
		<body>
			...
			<jsp:include page="/sys_jsp/notification.jsp"></jsp:include>
				<div class="tab-content default-tab" id="tab1">
					<form action="<%=basePath %>partTimeInfo/partTimeInfo_add.do" method="post" name="mainform">
					<table>
					<tr>
					    <td>
					...
					<tr>
					    ...
					    <td>
						    <input class="text-input small-input" type="text" id="workadd" name="workadd" rule="CHAR_M_120"/>
					...
					<tr>
					    ...
					    <td>
						    <input class="text-input small-input" type="text" id="money" name="money" rule="CHAR_M_120"/>
					...
					<tr>
					    ...
					    <td>
						    <input class="text-input small-input" type="text" id="linkname" name="linkname" rule="CHAR_M_120"/>
