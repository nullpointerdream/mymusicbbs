		...
		<body>
			...
			<div class="content-box-content">
				...
				<jsp:include page="/sys_jsp/notification.jsp"></jsp:include>
					<form id="searchForm" name="searchForm" action="applyInfo/applyInfo_query4me.do" method="post">
								...
								<c:forEach items="${result}" var="record">
									<tr>
										...
										<!--<td><a href="<%=basePath %>applyInfo/applyInfo_detail.do?id=${record.id }" title="title">${record.id }</a></td>-->
											...
											<td>
											<a href="<%=basePath %>partTimeInfo/partTimeInfo_detail4app.do?id=${record.parttimeid }" title="title">
