		...
		<body>
			...
			<div class="tab-content default-tab" id="tab1">
				<fieldset>
					...
					<p>
						<b><public:i18n key="stunum" module="applyInfo"></public:i18n>:</b>
						<label>${result.stunum}</label>
					</p>
					<p>
						<b><public:i18n key="college" module="applyInfo"></public:i18n>:</b>
						<label>${result.college}</label>
					</p>
					<p>
						<b>专业:</b>
						<label>${result.zy}</label>
					</p>
					
					<p>
						<b><public:i18n key="classinfo" module="applyInfo"></public:i18n>:</b>
						<label>${result.classinfo}</label>
					</p>
					<p>
						<b>曲风:</b>
						<label>${result.qf}</label>
					</p>
					<p>
						<b><public:i18n key="dormitory" module="applyInfo"></public:i18n>:</b>
						<label>${result.dormitory}</label>
					</p>
					<p>
