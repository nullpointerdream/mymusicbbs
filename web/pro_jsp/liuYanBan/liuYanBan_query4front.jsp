		...
		<head>
			...
			<script type="text/javascript">
				function toPage(pageNum){
					var url = "liuYanBan/liuYanBan_query4front.do?curPage="+pageNum;
		...
		<body>
			...
			<div class="content-box-content">
				...
				<jsp:include page="/sys_jsp/notification.jsp"></jsp:include>
					<form id="searchForm" name="searchForm" action="liuYanBan/liuYanBan_query4front.do" method="post">
								...
								<c:forEach items="${result}" var="record">
									<tr>
										...
										<!--<td><a href="<%=basePath %>liuYanBan/liuYanBan_detail.do?id=${record.id }" title="title">${record.id }</a></td>-->
											<td>
											<a href="<%=basePath %>liuYanBan/liuYanBan_detail4front.do?id=${record.id }" title="title">
											${record.title}
											</a>
											</td>
