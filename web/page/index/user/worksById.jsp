		...
		<div class="fly-home fly-panel"
			...
			<div class="fly-sns" data-user="">
				<a href="javascript:;" class="layui-btn layui-btn-primary"
					...
					class="layui-btn layui-btn-normal fansThis" data-id="118">关注</a>
			</div>
		...
		<div class="fly-panel fly-column">
			<div class="layui-container">
				<ul class="layui-clear" style="text-align: center;">
					<li ><a href="<%=basePath%>/admin/admin_userInfoById.do"
						data-pjax>他的收藏</a></li>
					<li class="layui-this"><a href="<%=basePath%>/admin/admin_worksById.do" data-pjax>他的作品</a></li>
			...
			<div class="fly-panel fly-panel-user" pad20>
				<div class="layui-tab layui-tab-brief" lay-filter="user">
					<ul class="layui-tab-title" id="LAY_mine">
						<li class="layui-this" lay-id="topic">他的作品</li>
					</ul>
                        ...
                        <table class="layui-table mar-no" lay-skin="line">
                            ...
                            <tr>
                               <th>歌曲名称</th>
								...
								<tr>
                               <td style="max-width: 350px;" class="layui-elip"><a href="javascript:;" class="SMPlay" data-id="${record.id }">${record.musicname}</a> </td>
