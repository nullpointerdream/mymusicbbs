			...
			<div class="fly-panel fly-panel-user" pad20>
				<div class="layui-tab layui-tab-brief" lay-filter="user">
					<ul class="layui-tab-title" id="LAY_mine">
						<li class="layui-this" lay-id="topic">收藏</li>
					...
					<div class="layui-tab-content" style="padding: 20px 0;">
                        ...
                        <table class="layui-table mar-no" lay-skin="line">
                            ...
                            <tr>
								...
								<td> 
								<a  class="active collectThis"  data-id="${record.musicid}" title="取消收藏"><i class="fa fa-star text-active"></i></a>
...
<script type="text/javascript">
	function toPage(pageNum){
		var url = "admin/admin_userInfo.do?curPage="+pageNum;
